...
export default function Home() {
  return <main id="top">
    ...
    <div id="content">
      ...
      <section className="section cream" id="report-pathway"><div className="shell"><div className="section-head"><div><div className="eyebrow">Your report, your next steps</div><h2>A practical pathway toward stronger credit.</h2><p className="lead">Start with your own reports from <a href="https://www.annualcreditreport.com/index.action" target="_blank" rel="noopener noreferrer">AnnualCreditReport.com</a>. Check each bureau for possible factual errors, document what you find, and use the free dispute process if something is inaccurate.</p></div></div><div className="cards"><article><span>01</span><h3>Protect payment history</h3><p>Track due dates and contact your creditor promptly if a payment is at risk.</p></article><article><span>02</span><h3>Review balances</h3><p>Use the free utilization and payoff estimates above to plan manageable steps.</p></article><article><span>03</span><h3>Verify report entries</h3><p>Dispute suspected inaccuracies with accurate supporting information. You can do this yourself at no charge.</p></article></div><p>To discuss your report with us, book a consultation first and request a verified secure document-sharing method. Do not email an unredacted report, account number, Social Security number, or bureau password. Different score models may give different results; an 800 score or any specific outcome cannot be promised.</p></div></section>
